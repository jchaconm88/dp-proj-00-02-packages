    ...
    <div className="pt-4 space-y-4">
      <div className="flex flex-wrap items-start justify-between gap-3 px-1">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Button type="button" label={backLabel} icon="pi pi-chevron-left" className="dp-btn-soft" onClick={onBack} />
          {canShowFilter && (
            <Button type="button" label={filterLabel} icon="pi pi-filter" className="dp-btn-soft" onClick={onFilterAction} />
          )}
          {canShowEdit && (
            <Button type="button" label={editLabel} icon="pi pi-pencil" className="dp-btn-soft" onClick={onEdit} />
          )}
          {canShowCreate && (
            <Button type="button" label={createLabel} icon="pi pi-plus" className="dp-btn-neon" onClick={onCreate} />
          )}
        </div>
      </div>
